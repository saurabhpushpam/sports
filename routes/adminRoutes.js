...
get_route.post('/post-data', upload.array('images'), admincontroller.insertproduct);
get_route.post('/update', upload.array('images'), admincontroller.updateproduct);
get_route.post('/delete/:id',  admincontroller.deleteproduct);
get_route.get('/get-image/:image', admincontroller.getimage);
